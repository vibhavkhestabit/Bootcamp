...
Here we got an overview of a webpage and we had to use only semantic tags to replicate it or a website of our own so that we get to know the functionalities and features of those tags thoroughly.

The core learnig for the day was to learn how to aptly use Semantic Tags which include Headers, Footers, Main, Article, figure, img, nav, etc

By name we can understand that every semantic tag has its own meaning and function.
