...
class ImageSearch:
    ...
    def _search(self, query_vector, top_k):
        ...
        # Normalize the search query to match the database vectors
...
if __name__ == "__main__":
    ...
    print("="*50)
    results_mode_1 = searcher.search_by_text("dog", top_k=3)
    ...
    print("="*50)
    # Using the exact flow diagram you ingested earlier
    test_image_path = "src/data/images/bar_chart_image23.png.jpg" 
    
    if os.path.exists(test_image_path):
        # top_k=2 because the 1st result will naturally be the exact same image you searched with!
        ...
        print(f"⚠️ Could not find {test_image_path} to run Mode 2 test.")
