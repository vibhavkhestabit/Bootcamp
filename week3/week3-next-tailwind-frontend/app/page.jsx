...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-[#0f0720] overflow-hidden selection:bg-orange-500">
      <section className="w-full bg-gradient-to-br from-[#1e0b36] via-[#2e1065] to-[#0f0720] pt-24 pb-36 rounded-bl-[100px] md:rounded-bl-[200px] relative">
            ...
            <div className="h-1/2 flex flex-col justify-between pt-2">
              <div className="grid grid-cols-2 gap-6">
                <div className="p-5 h-[210px] bg-white/5 border-l-4 border-red-600 backdrop-blur-md rounded-r-xl transition-all duration-300 hover:bg-white/10 hover:scale-[1.02]">
                  <p className="text-[18px] font-black text-red-500 uppercase tracking-widest mb-1">
                    Success Metric
                  </p>
                  <p className="text-white text-[16px] font-bold tracking-tight">
                    98.4% Efficiency Rate
                  </p>
                  <p className="pt-1 text-slate-400 text-[14px] mt-1 leading-tight">
                    Optimized every internal project pipeline to maximize team
                    velocity.
                  </p>
                </div>
                <div className="p-5 h-[210px] bg-white/5 border-l-4 border-amber-500 backdrop-blur-md rounded-r-xl transition-all duration-300 hover:bg-white/10 hover:scale-[1.02]">
                  <p className="text-[18px] font-black text-amber-500 uppercase tracking-widest mb-1">
                    Global Impact
                  </p>
                  <p className="text-white text-[16px] font-bold tracking-tight">
                    2.4M+ Data Points
                  ...
                  <p className="pt-1 text-slate-400 text-[14px] mt-1 leading-tight">
                    Information is synchronized in real-time daily across every
                    active node.
                  </p>
                </div>
              </div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={i}
              className={`p-8 bg-white/5 border-t-4 ${feat.border} backdrop-blur-md rounded-xl hover:bg-white/10 transition-all duration-300 hover:-translate-y-2 cursor-default group`}
            >
              <div className="mb-6 transform group-hover:scale-110 transition-transform">
                {feat.svg}
              </div>
              <h3 className="text-xl font-bold text-white mb-4 uppercase italic tracking-tighter">
                {feat.title}
              </h3>
      ...
      {/* TESTIMONIALS SECTION - Updated with Unique Feedback */}
            ...
            {[
              {
                ...
                role: "CTO, NexaCorp",
                quote:
                  "Hestabit redefined our workflow. The control dashboard is beyond anything we’ve used, turning complex data into actionable insights.",
              },
              {
                name: "Puneet Kapoor",
                role: "Ops Director, Velo",
                quote:
                  "The transformation to this digital ecosystem was seamless. Monitoring project health and revenue growth in real-time has never been this intuitive.",
              },
              {
                name: "Lakhwinder Singh",
                role: "Lead Dev, Ironhold",
                quote:
                  "The transition from a standard login gate to a comprehensive operational hub is executed with flawless precision and high-performance engineering.",
              },
              {
                name: "Shreya Shrivastav",
                role: "VP Product, Zenith",
                quote:
                  "The 'Verdict' system is a game-changer for HR. We finally have a transparent, high-fidelity view of our team's performance and punctuality.",
              },
            ].map((user, i) => (
              <div
                key={i}
                className="p-6 bg-[#160b2e] border border-white/10 rounded-2xl shadow-xl transition-all duration-500 hover:scale-105 hover:border-purple-500/50 hover:shadow-purple-500/10 group cursor-default flex flex-col justify-between h-full"
              >
                <div>
                  <div className="flex text-red-500 mb-4 text-[10px] tracking-widest">
                    ★★★★★
                  </div>
                ...
                <div className="flex items-center gap-3 mt-auto">
                  ...
                  <div>
                    <p className="text-white text-[11px] font-black uppercase tracking-tighter group-hover:text-purple-400 transition-colors">
                      {user.name}
                    </p>
      ...
      <footer className="pt-12 pb-6 px-6 border-t border-white/5 bg-[#0a0516]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-16 mb-20">
          <div>
            <h2 className="text-white font-black text-3xl uppercase italic mb-6 tracking-tighter">
              Hestabit
            </h2>
            <div className="space-y-2 border-l-2 border-red-600 pl-4">
              ...
              <p className="text-red-500 text-xs font-black tracking-tighter">
                +91 8130907023
              </p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-12">
            <div>
              <h4 className="text-white font-bold uppercase text-[10px] mb-6 tracking-widest opacity-50">
                Platform
              </h4>
